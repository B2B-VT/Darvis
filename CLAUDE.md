...
- `frontend/src/mock-data.js` — mock data imported directly by `dashboard-prof.jsx` and `courses.jsx`; undocumented previously, worth confirming why production components still depend on it
