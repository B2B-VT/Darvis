...
- "section_lookup": who is teaching a course this semester, what times/days/location is a course offered, when does a specific professor teach a course, seat availability ("is CS 3114 full?", "how many seats", "open seats", "where is CS 3114 held?", "what building")
